...
class Game {
 ...
 private:
  ...
  std::vector<int> const artefact_vals{5, 6, 7, 9, 10, 11, 12, 13, 14};
  std::vector<int> const artefact_collect_states{0, 1, 1, 1, 1, 1, 0, 0, 1};
  std::vector<int> const artefact_pass_states{1, 0, 0, 0, 1, 1, 1, 1, 0};
  LevelMap levelmap;
